...
const ModalAgregarTarea: React.FC<ModalAgregarTareaProps> = ({ showModal, handleClose, createTask }) => {
    ...
    const validationSchema = Yup.object({
        ...
        tiempo: Yup.number().required('Este campo es obligatorio').integer('El tiempo debe ser en números enteros').positive('El tiempor debe ser un numero mayor que 0 (cero)'),
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            values.estado.toUpperCase(); //Convierte el estado a mayúsculas
